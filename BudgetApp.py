...
class BudgetApp(App):
    def build(self):
        ...
        with top_bar.canvas.before:
            Color(0.36, 0.27, 0.21, 1)  # Moss Green   
        ...
        btn_add = Button(
            ...
            on_release=self.open_text_window
        )
    ...
    def open_text_window(self, instance):
        ...
        close_btn = Button(text="Save", size_hint=(1, 0.3))
        close_btn.bind(on_release=lambda x: self.save_text())
